...
export function VideoPanel({
  ...
  return (
    <div
      className={cn(
        "flex h-full flex-col bg-white p-4 transition-all duration-300",
        highlightPanel && "bg-purple-50 ring-4 ring-purple-500/75"
      )}
      data-tour="video-panel"
    >
      <div
        className={cn(
          "relative overflow-hidden rounded-2xl border-2 bg-background shadow-xl transition-all duration-300",
          highlightPanel
